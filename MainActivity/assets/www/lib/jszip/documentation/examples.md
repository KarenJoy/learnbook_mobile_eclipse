...
zip.file("hello.txt", "Learnbook\n");

// create a file and a folder
zip.file("nested/hello.txt", "Learnbook\n");
// same as
zip.folder("nested").file("hello.txt", "Learnbook\n");
```
...
```js
zip.file("hello.txt").asText(); // "Learnbook\n"
...
new_zip.file("hello.txt").asText(); // "Learnbook\n"
```
